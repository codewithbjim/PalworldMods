...
step multiplier; vertical movement limits; and verbose diagnostic logging.
These settings are validated both by
...
The companion guide resolves its displayed controls to Palworld's stock keycap
