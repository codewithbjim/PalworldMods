...
local aliases = {
    ...
    XBUTTON_ONE = "MOUSE_BUTTON_4",
    XBUTTON_TWO = "MOUSE_BUTTON_5",
    HYPHEN = "MINUS",
}
...
-- Keep modifier order stable across config.lua, conflict signatures, UE4SS
-- registration, and the companion widget.
